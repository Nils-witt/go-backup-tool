...
// touching disk.
func testServerIdentity(t *testing.T) *backup.ServerIdentity {
	t.Helper()
...
func testServerIdentityAndKey(t *testing.T) (*backup.ServerIdentity, *rsa.PrivateKey) {
	t.Helper()
	...
	return backup.NewTestServerIdentity("test-sender-uuid", key), key
}

...
// keep checking on a fixed schedule" loop in this codebase (the
// stale-receiver monitor and a job's own interval-based schedule), which
// otherwise each hand-roll the same ticker/select loop.
